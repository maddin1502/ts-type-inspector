...
export abstract class Validator<V extends I, I = unknown> implements Validatable<V, I> {
   ...
   * @memberof Validator
   */
  public isValid(value_: I): value_ is V {
    try {
  ...
  protected abstract validateBaseType(value_: I): V;
